...
import org.example.part4.two.Book;
import org.example.part4.two.Item;
import org.example.part4.two.PersonalInformation;
...
//        personalInfo();
    ...
    private static void personalInfo(){
        ...
        while(true){
            ...
            info.add(new PersonalInformation(name,lastName,id));
        }
    ...
    private static void books(){
        ...
        if(option.equalsIgnoreCase("everything")){
            for(Book b : books){
